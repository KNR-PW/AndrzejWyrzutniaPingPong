...
#Komunikacja z Andrzejem za pomocą pada do PS4. Można strzelać i jeździć.
import pygame
import serial
import time
...
try:
    while True:
        ...
        turn = mapToByte(joystick.get_axis(0), -1, 1, 0, 255)
        gunElevation = 255-mapToByte(joystick.get_axis(3), -1, 1, 0, 255)
        gunRotation = mapToByte(joystick.get_axis(2), -1, 1, 0, 255)
        przyciski = 0x00
        ...
        bt.write([forward,turn, gunElevation, gunRotation,przyciski,0,0,0])
